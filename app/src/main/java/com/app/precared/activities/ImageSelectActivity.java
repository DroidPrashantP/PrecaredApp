...
public class ImageSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent == null) {
            ...
            album = intent.getStringExtra(Constants.AttachmentsKeys.INTENT_EXTRA_ALBUM);
    ...
    private void requestPermission() {
        if (ContextCompat.checkSelfPermission(ImageSelectActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ImageSelectActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, Constants.AttachmentsKeys.PERMISSION_REQUEST_READ_EXTERNAL_STORAGE);
            return;
        }
    ...
    private void toggleSelection(int position) {
        if (!images.get(position).isSelected && countSelected >= Constants.AttachmentsKeys.limit) {
            Toast.makeText(getApplicationContext(), String.format(getString(R.string.limit_exceeded), Constants.AttachmentsKeys.limit), Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void sendIntent() {
        ...
        intent.putParcelableArrayListExtra(Constants.AttachmentsKeys.INTENT_EXTRA_IMAGES, getSelected());
    ...
    private class CustomImageSelectAdapter extends CustomGenericAdapter<Image> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = layoutInflater.inflate(R.layout.layout_image_select, null);
            ...
            if (arrayList.get(position).isSelected) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    convertView.setForeground(context.getResources().getDrawable(R.drawable.ic_tick_white));
                }
            ...
            Picasso.with(context)
                    ...
                    .resize(200, 200)
                    .placeholder(R.drawable.place_product).into(viewHolder.imageView);
