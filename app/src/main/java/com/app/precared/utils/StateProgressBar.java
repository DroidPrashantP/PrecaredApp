...
/**
 * Created by Prashant on 15/10/2016.
 */
...
public class StateProgressBar extends View {
    ...
    public enum StateNumber {
        ONE(1), TWO(2), THREE(3), FOUR(4), FICE(5) , SIX(6), SEVEN(7), EIGHT(8), NINE(9);
        public int value;
    ...
    public float mStateNumberTextSize;
    ...
    private void updateCheckAllStatesValues(boolean enableAllStatesCompleted) {
        if (enableAllStatesCompleted) {
            ...
            this.mCurrentStateNumber = mMaxStateNumber = StateNumber.NINE.getValue();
    ...
    private void initStateProgressBar(Context context) {
        ...
        mMaxStateNumber = StateNumber.NINE.getValue();
